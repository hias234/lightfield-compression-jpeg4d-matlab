...
% decompresses a 4d-block 
    ...
    block2d = reshape(block1d, [8,8]); % TODO this may needs to be changed...
    ...
    block2d_idct = block2d_idct + 128;% TODO add 128???
    
    decompressed_block = map2dTo4d(block2d_idct, 4, 4, 2, 2);
