...
LF = ImportLF('./lightfields/legoknights-small_17x17/',17,[1,1],1.0);
...
[compressed_lf, huffdict] = compress(LF, quality, false, true, false);
disp('compressed')
%% decompress

LF_dec = decompress(compressed_lf, huffdict, quality, T, S, c, U, V, false, true, false);
disp('decompressed')
